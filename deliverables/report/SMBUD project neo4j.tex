	...
	\item[] For simplicity, contacts coming from tracking applications
	 go from 28/10/2021 to 10/11/2021.
        ...
        \item[] For tracking purposes, a person is considered \emph{infected}
            up to 14 days prior the positive test. \todo{in che senso?}
    \end{itemize}
...
\noindent % Removes indentation after box
Returns the number of contacts registered for each type of device. \todo{aggiungere spiegazione del where}
...
time of the contact. \\
\todo{aggiungere: nelle location guardiamo da 2 h prima a 2 h dopo e che consideriamo tutta la famiglia}
Takes the following parameters: 
\begin{itemize}
